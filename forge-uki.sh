...
CMDLINE="$CMDLINE alpine_dev=LABEL=QUAY_STORAGE alpine_repo=/media/QUAY_STORAGE/apks"
...
CMDLINE="$CMDLINE modloop=/media/QUAY_STORAGE/modloop-lts modloop_verify=no"
